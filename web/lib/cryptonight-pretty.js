...
STATICTOP = STATIC_BASE + 12832;
__ATINIT__.push();
var STATIC_BUMP = 12832;
...
var CryptonightWASMWrapper = (function() {
    this.throttleWait = 0, this.throttledStart = 0, this.throttledHashes = 0, this.workThrottledBound = this.workThrottled.bind(this), this.currentJob = null, this.target = new Uint8Array([255, 255, 255, 255, 255, 255, 255, 255]);
    var e = Module.HEAPU8.buffer;
    this.input = new Uint8Array(e, Module._malloc(84), 84), this.output = new Uint8Array(e, Module._malloc(32), 32), self.postMessage("ready"), self.onmessage = this.onMessage.bind(this)
});
CryptonightWASMWrapper.prototype.onMessage = (function(e) {
    var t = e.data;
    return t.verify_id ? void this.verify(t) : (this.currentJob && this.currentJob.job_id === t.job_id || this.setJob(t), void(t.throttle ? (this.throttleWait = 1 / (1 - t.throttle) - 1, this.throttledStart = this.now(), this.throttledHashes = 0, this.workThrottled()) : this.work()))
}), CryptonightWASMWrapper.prototype.hexToBytes = (function(e, t) {
    for (var t = new Uint8Array(e.length / 2), r = 0, n = 0; n < e.length; n += 2, r++) t[r] = parseInt(e.substr(n, 2), 16);
    return t
    ...
    7 < e ? this.cryptonight_variant = 2 : 7 === e ? this.cryptonight_variant = 1 : this.cryptonight_variant = 0;
    if (h) {
        this.cryptonight_variant = 4;
        this.height = h
    }
}), CryptonightWASMWrapper.prototype.setJob = (function(e) {
    this.currentJob = e, this.blob = this.hexToBytes(e.blob), this.input.set(this.blob), this.setVersion(this.blob[0], e.height);
    ...
    this.input[39] = (4278190080 & n) >> 24, this.input[40] = (16711680 & n) >> 16, this.input[41] = (65280 & n) >> 8, this.input[42] = (255 & n) >> 0, _cryptonight_hash(e.byteOffset, t.byteOffset, r, this.cryptonight_variant, this.height)
    ...
    var e = 0,
        ...
        r = this.now(),
        n = 0;
    do this.hash(this.input, this.output, this.blob.length), e++, t = this.meetsTarget(this.output, this.target), n = this.now() - r; while (!t && n < 1e3);
    var o = e / (n / 1e3);
    if (t) {
    ...
    } else if (n > 1e3) self.postMessage({
        hashesPerSecond: o,
        hashes: this.throttledHashes
    }), this.throttledHashes = 0;
    else {
